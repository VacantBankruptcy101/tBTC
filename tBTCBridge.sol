...
// Import with alias to avoid any naming conflicts
import {tBTCToken as TBTC} from "./tBTCToken.sol";
...
contract tBTCBridge is ReentrancyGuard, AccessControl {
    ...
    // State variables - using alias TBTC as the type
    ...
    // State variables - Type Visibility Name format
